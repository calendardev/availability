  ...
  function CalendarDateButton({ invisible, firstDay, day, index }) {
    ...
    return (
      <button
        ...
        type="button"
        className={`py-2 m-1 bg-blue-100 hover:bg-blue-200 font-semibold rounded-full text-blue-700 hover:text-blue-800 disabled:text-gray-200 disabled:bg-transparent focus:z-10 ${invisible}`}
      >
        <time
          dateTime="2021-12-27"
    ...
    return (
      <>
        {isLoading ? (
          ...
          <div
            className={`ease-in duration-300 transition-all isolate mt-2 grid grid-cols-7 gap-px rounded-lg text-sm ${
